/**
 * Mesmo algoritmo do backend (apps/api/.../clientes/domain/validar-documento.ts)
 * - duplicado propositalmente aqui para feedback imediato no formulário, sem
 * pacote compartilhado ainda (mesmo padrão das Etapas 3-5). O backend é
